...
<div className="container overflow-hidden flex flex-col lg:flex-row justify-between mx-auto px-4">
    ...
    <Link to='/'>
           <img className=' w-[100%] h-[35px] ' src={logo}/>
           </Link>
    </div>
        <div className=" lg:w-3/6 md:w-full sm:w-full flex  sm:flex   text-sm mt-6 lg:mt-0">
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li className="inline-block py-2 px-3 text-white text-base  font-medium tracking-wide">Product</li>
            ...
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li className="inline-block py-2 px-3 text-white text-base  font-medium tracking-wide">Company</li>
                <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Privacy</a>
                </li>
                <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Terms of Service</a></li>
            </ul>
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li className="inline-block py-2 px-3 text-white text-base  font-medium tracking-wide">Developers</li>
     ...
     <h3 className="text-xl mb-3 text-center"> Download our app </h3>
     <div className="flex justify-center my-5">
            ...
            <div className="text-gray-700 flex flex-col justify-center items-center w-full">
                <div className="inline-block py-2 px-3 text-white text-base font-medium tracking-wide">Follow Us</div>
    ...
    <div className="pt-4 mt-4 pt-6 text-gray-600 border-t border-gray-800 flex flex-col md:flex-row justify-center items-center">
      <div> Develop by Mohammad Yusuf © 2023</div> 
